...
const Reports = () => {
    ...
    // Multi-branch selection UI (for main managers)
        ...
        <div className="table-page reports-page">
            ...
            <div className="form-section" ref={formSectionRef}>
                ...
                <div style={{ marginTop: 'var(--spacing-lg)', marginBottom: 'var(--spacing-lg)' }}>
                    ...
                    <div className="fields-grid" style={{ maxHeight: '200px', overflowY: 'auto' }}>
                        {Object.entries(DOCUMENT_TYPE_LABELS).map(([docType, label]) => (
                            <label key={docType} className="checkbox-label" style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-sm)', padding: 'var(--spacing-sm)', borderRadius: 'var(--radius-md)', cursor: 'pointer' }}>
                                <input
                                    type="checkbox"
                ...
                {/* File Type Selection */}
                <div style={{ marginBottom: 'var(--spacing-lg)' }}>
                    <h3 style={{ marginBottom: 'var(--spacing-sm)', fontSize: 'var(--font-size-lg)', fontWeight: 600 }}>نوع الملف</h3>
